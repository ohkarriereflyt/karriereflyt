                ...
                <div className="flex flex-row md:flex-col w-full">
                    ...
                    <div className="w-full md:p-3 md:pb-2 pl-3 pr-2 py-2 flex-col justify-between items-end flex">
                        <div className="self-stretch">
                            ...
                            <p className="self-stretch ">{member.title}</p>
                                ...
                                <div className="self-stretch h-20 py-2 flex-col justify-start items-end md:flex hidden">
                                    {member.email && (
                                        <div className="self-stretch justify-start items-center gap-2.5 inline-flex">
                                            <h3 className="w-16 ">Email:</h3>
                                            <p className=" leading-loose">{member.email}</p>
                                        </div>
                                    )}
                                    {member.phone && (
                                        <div className="self-stretch justify-start items-center gap-2.5 inline-flex">
                                            <h3 className="w-16 ">Telefon:</h3>
                                            <p className=" leading-loose">{member.phone}</p>
                                        </div>
                                    )}
                                </div>
                        ...
                        <div className="self-stretch md:px-6 md:py-3 justify-between items-center inline-flex background-flat">
                            <button
                                ...
                                className={`hover:scale-105 noStyle w-8 h-8 flex-col justify-center items-center inline-flex ${!member.phone && 'opacity-50 cursor-default'}`}>
                            ...
                            <button
                                ...
                                className={`hover:scale-105 noStyle w-8 h-8 flex-col justify-center items-center inline-flex ${!member.email && 'opacity-50 cursor-default'}`}>
