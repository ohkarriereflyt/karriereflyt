...
import Banner from "../images/banner-slategray-left-aligned.svg";
    ...
    <nav className="fixed z-10 w-full overflow-hidden navbar">
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center flex-col lg:flex-row">
          <div className="flex justify-between items-center w-full lg:w-auto">
            <Link href="/" className="flex">
              <div className="flex items-center mr-2 h-20">
                <Image
                  src={Banner}
                  alt="Karriereflyt Logo"
                  className="w-48 h-16 md:w-64 md:h-20 lg:w-72 lg:h-24"
                />
              </div>
            </Link>
          ...
          <ul
            className={`flex flex-col items-start space-y-4 w-full pt-3 pb-6 ${
              isOpen ? "block" : "hidden"
            } lg:hidden`}
          >
            <li>
            ...
            <li>
              <Link
                href="/applicants"
                className={mobileLinkStyle("/applicants")}
                onClick={closeMenu}
              >
                For jobbsøkere
              </Link>
          ...
          <div className="hidden lg:flex w-full justify-end">
            <ul className="flex flex-row items-center space-x-7">
              ...
              <li>
                <Link
                  href="/applicants"
                  className={desktopLinkStyle("/applicants")}
                >
                  For jobbsøkere
                </Link>
              </li>
              <li>
                <Link
                  href="/services"
                  className={desktopLinkStyle("/services")}
                >
                  Tjenester
                </Link>
              </li>
