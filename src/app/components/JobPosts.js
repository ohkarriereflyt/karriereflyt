  ...
  function highlightText(text, query) {
    ...
    return parts.map((part, index) =>
      part.toLowerCase() === query.toLowerCase() ? (
        <span key={index} style={{ backgroundColor: "#A5BBC2" }}>
          {part}
        </span>
      ) : (
        part
        ...
        <div className="kf-border-light light-background w-full flex items-center relative">
          <div className="w-full h-full">
            <label htmlFor="message" className="sr-only">
              Søk etter stilling, sted, firma etc.
            </label>
            <input
              id="message"
              name="message"
          ...
          <button className="h-full slate-gray-background px-6 py-4 absolute right-0">
            ...
            >
              <path
                d="M0.917969 8.16016C0.917969 12.457 4.41406 15.9531 8.71094 15.9531C10.4102 15.9531 11.9629 15.4063 13.2422 14.4883L18.0469 19.3027C18.2715 19.5274 18.5645 19.6348 18.877 19.6348C19.541 19.6348 20 19.1367 20 18.4824C20 18.1699 19.8828 17.8867 19.6778 17.6817L14.9024 12.877C15.9082 11.5684 16.5039 9.9375 16.5039 8.16016C16.5039 3.86328 13.0078 0.367188 8.71094 0.367188C4.41406 0.367188 0.917969 3.86328 0.917969 8.16016ZM2.58789 8.16016C2.58789 4.78125 5.33203 2.03711 8.71094 2.03711C12.0899 2.03711 14.834 4.78125 14.834 8.16016C14.834 11.5391 12.0899 14.2832 8.71094 14.2832C5.33203 14.2832 2.58789 11.5391 2.58789 8.16016Z"
                fill="#FFFBF8"
              />
            </svg>
          </button>
        ...
        <div className="lg:w-[320px] w-full flex-shrink-0">
          <div className="flex items-end space-x-4 mb-2">
            <div className="text-3xl flex items-baseline">
              {props.numberOfPositions}
              <p className="ml-1">stillinger</p>
            </div>
            <div className="text-3xl flex items-baseline">
              {props.numberOfPosts}
              <p className="ml-1">stillingsannonser</p>
            </div>
          </div>
          ...
          <div className="shadow kf-border-light light-background w-full">
            <div className="min-h-[56px] slate-gray-background  flex justify-center items-center w-full px-6 py-3 text-center">
              ...
              <button
                className="lg:hidden block absolute right-3 top-3"
              ...
              >
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  style={{ transform: filterOpen ? "scaleY(-1)" : "scaleY(1)" }}
                >
                  <path
                    className="light-stroke"
                    d="M24 15.332L18 21.332L12 15.332"
                    strokeWidth="2.57143"
                    strokeLinecap="round"
                ...
                <div className="flex flex-col slate-gray">
                  <div className="w-full h-auto px-4 py-2 flex-col justify-start items-start flex overflow-y-auto">
                    <div className="w-full h-auto flex-col justify-start items-start flex">
                      ...
                      {props.uniqueRegions.map((region) => (
                        <div
                          key={region.regionId}
                          className="w-full py-2 justify-start items-center gap-2 inline-flex"
                        >
                          <input
                          ...
                          <p>
                            ...
                            {
                              jobApi.filter(
                                (job) => job.regionId === region.regionId
                              ).length
                            }
                            )
                          </p>
                  ...
                  <div className="w-full h-auto px-4 py-2 flex-col justify-start items-start flex overflow-y-auto">
                    ...
                    {props.finishedBranch.map((branch, index) => (
                      <div
                        key={`branchCategoryId-${
                          branch.branchCategoryId || index
                        }`}
                        className="w-full py-2 justify-start items-center gap-2.5 inline-flex"
                      >
                        <input
                          checked={selectedBranches.includes(
                            branch.branchCategoryId
                          )}
                          type="checkbox"
                          className="w-4 h-4 mx-1"
                          onChange={() =>
                            handleBranchClick(branch.branchCategoryId)
                          }
                        />
                        ...
                        <p>
                          (
                          {
                            jobApi.filter(
                              (job) =>
                                job.branchCategoryId === branch.branchCategoryId
                            ).length
                          }
                          )
                        </p>
                  ...
                  >
                    ...
                    <div className="p-4 w-full overflow-auto">
                      <h2 className="line-clamp-3">
                        {highlightText(job.companyName, searchQuery)}
                      </h2>
                    ...
                    <div className="md:w-[256px] w-full p-4 pb-0 flex flex-col justify-between flex-shrink-0 slate-gray-background">
                      <div className="max-w-full overflow-hidden light">
                        ...
                        <div className="flex gap-2 py-1 items-center">
                          ...
                          >
                            ...
                            />
                            <path
                              d="M8.53613 7.72699C8.53613 6.33081 9.68529 5.20312 11.0707 5.20312C12.4669 5.20312 13.6054 6.33081 13.6054 7.72699C13.6054 8.87614 12.8535 9.82124 11.8333 10.122V15.6745C11.8333 17.3284 11.5862 18.7568 11.0707 18.7568C10.5659 18.7568 10.2975 17.2961 10.2975 15.6745V10.122C9.28791 9.8105 8.53613 8.8654 8.53613 7.72699Z"
                              fill="white"
                            />
                          </svg>
                      ...
                      <div className="flex justify-end items-center sm:pb-1">
                        <ButtonArrow direction="right"></ButtonArrow>
                      </div>
                    </div>
                  </Link>
                </li>
