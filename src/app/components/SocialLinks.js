    ...
    return (
            <div className={`w-full ${paddingX ? 'px-6' : ''} py-3 justify-between items-center inline-flex background-flat`}>
                ...
                <button
                    ...
                    className={`noStyle w-8 h-8 flex-col justify-center items-center inline-flex ${!employee.linkedin && 'opacity-50 cursor-default'}`}>
                    <svg viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
