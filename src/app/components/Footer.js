      ...
      <div className="w-full flex flex-col items-center bg-slate-gray-flat text-text-flat-inverted">
        ...
        <div className="w-full max-w-7xl flex justify-center items-center flex-row p-4 ">
          {socialMediaLinks.linkedin != null && (
            <Link
              href={socialMediaLinks.linkedin} target="_blank"
          ...
          {socialMediaLinks.facebook != null && (
            <Link
              href={socialMediaLinks.facebook} target="_blank" className={`hover:scale-105 noStyle w-8 h-8 flex-col justify-center items-center inline-flex`}>
          ...
          {socialMediaLinks.twitter != null && (
            <Link
              href={socialMediaLinks.twitter} target="_blank" className={`hover:scale-105 noStyle w-8 h-8 flex-col justify-center items-center inline-flex`}>
          ...
          {socialMediaLinks.instagram != null && (
            <Link
              href={socialMediaLinks.instagram} target="_blank" className={`hover:scale-105 noStyle w-8 h-8 flex-col justify-center items-center inline-flex`}>
              <svg width="18" height="19" viewBox="0 0 18 19" xmlns="http://www.w3.org/2000/svg">
          ...
          {socialMediaLinks.youtube != null && (
            <Link
              href={socialMediaLinks.youtube} target="_blank" className={`hover:scale-105 noStyle w-8 h-8 flex-col justify-center items-center inline-flex`}>
