  ...
  const footerItems = [
    {
      ...
      items: ["Org. nr: 930 011 428", "Rekruttering og bemanning"],
    },
    {
      header: "Kontakt oss",
      items: [
  ...
  return (
    <footer className="relative w-full">
      ...
      <div className="w-full flex flex-col items-center bg-slate-gray-flat text-text-flat-inverted">
        <div className="w-full max-w-7xl flex-col flex md:flex-row justify-between flex-wrap">
              ...
              {footerItem.header === "Sider"
                ? footerItem.items.map((item, index) => (
                    <Link key={index} href={item.href} passHref>
                      <button className="text-footer block text-left pb-1 hover:underline">
                        {item.name}
                      </button>
                    </Link>
                  ))
                : footerItem.items.map((item, index) => (
                    <p key={index} className="text-footer pb-1">
                      {item}
                    </p>
                  ))}
            </div>
          ...
          {socialMediaLinks.facebook != null && (
            ...
            >
              ...
              >
                <path
                  className="light-fill"
                  d="M6.36902 18.9347V10.7387H9.07829L9.481 7.52965H6.36902V5.48565C6.36902 4.55965 6.62182 3.92565 7.92403 3.92565H9.57409V1.06465C8.7716 0.97665 7.9642 0.93465 7.15681 0.93765C4.76208 0.93765 3.1179 2.42965 3.1179 5.16865V7.52365H0.42627V10.7326H3.12378V18.9347H6.36902Z"
                />
              </svg>
            </Link>
          )}
