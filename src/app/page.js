  ...
  try {
    ...
    return (
      <main>
        ...
        <CustomerFeedback
          reviewsTitle={events.reviewsTitle}
          reviews={events.reviews}
        />
        <OurSubjectArea
          subjectAreasTitle={events.subjectAreasTitle}
          subjectAreaCont1Title={events.subjectAreasContainer1Title}
          subjectAreaCont1Items={events.container1Items}
          subjectAreaCont2Title={events.subjectAreasContainer2Title}
          subjectAreaCont2Items={events.container2Items}
          subjectAreaFooterText={events.subjectAreasFooterText}
        />
        <div className="background-blur">
          <JobbkretserPartner
            jobbkretserTitle={events.jobbkretserSectionTitle}
            jobbkretserContItems={events.jobbkretserContainerItems}
            jobbkretserImage={events.jobbkretserImage}
            jobbkretserReadMore={events.jobbkretserSectionReadMore}
          />
