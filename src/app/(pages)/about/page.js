...
export default async function Page() {
  ...
  return (
    <div>
      <Banner />
      <OurHistorySection
        title={events.mainTitle}
        text={formatTextWithBreaks(events.mainSectionText)}
        img={events.mainimg}
      />
      <OurVisionSection
        title={events.ourVisionTitle}
        text={formatTextWithBreaks(events.ourVisionText)}
        img={events.visionimg}
      />
